...
<div class="filter">
  ...
  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
    ...
    <li><input type="submit" name="All" class="dropdown-item" value="All Year" style="color:<?php echo $all ;?>"></button></li>
    <li><input type="submit" name="button1" id="jai" value ="First Year" class="dropdown-item" style="color:<?php echo $cs ;?>"></button></li>
    <li><input type="submit" name="button2" value ="Second Year" class="dropdown-item" style="color:<?php echo $eee ;?>"></li>
    <li><input type="submit" name="button3" class="dropdown-item" value="Third Year" style="color:<?php echo $ec ;?>"></li>
    <li><input type="submit" name="button4" value="Fourth Year" class="dropdown-item" style="color:<?php echo $it ;?>"></li>
      </forrm>
  </ul>
</div>
      <br><br><br>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  {
                    ?>
                     <!-- <th scope="row"><?php echo $row['HOD_Id']; ?></th> -->
