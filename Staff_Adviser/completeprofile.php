...
while($row = mysqli_fetch_assoc($rt))
  ...
  if(isset($_POST['editsubmit'])){
   ...
   $q="SELECT images FROM teachers where  Teacher_id = '$id' ";
  ...
  //    $filename = $_FILES["p"]["name"];
   ...
   // $i=mysqli_fetch_assoc($row['images']);
    $query="UPDATE teachers SET images='$pimage', T_Name='$names',age='$age',Temail='$email',phone='$phone',instagram1='$instagram',facebook1='$link' where Teacher_id = '$id' ";
  ...
  if(isset($_POST['passwordsubmit'])){
    ...
    $query="UPDATE teachers SET Tpassword='$currentpass' WHERE Teacher_id = '$id'";
    $result=mysqli_query($con,$query);
    if($result){
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $data['T_Name']; ?> </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $data['Temail']; ?> </div>
                  </div>
                  <div class="row">
                  ...
                  <form action="" method="POST">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="password" type="text" value=<?php echo $data["Tpassword"];?> class="form-control" id="currentPassword" readonly>
                      </div>
                    </div>
