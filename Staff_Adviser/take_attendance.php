...
$sql5="SELECT * from subject where Subject_name='$subname'";
  $sq=mysqli_query($con,$sql5);
 ...
 //
 $sql8="SELECT Teacher_id from student where Department='$Department' AND current_Semester=3";
  $sqt=mysqli_query($con,$sql8);
   $row=mysqli_fetch_assoc($sqt);
    $staff=$row['Teacher_id'];



$sql="INSERT INTO idtable(subid,date2,period1,Department,staff) values('$subid','$datees','$period','$Department','$staff')";
   ...
   <section class="section profile">
      <div class="row">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                    <label for="yearl" class="col-md-4 col-lg-3 col-form-label">Subject List</label>
                      <div class="col-md-8 col-lg-9">
                    <select name="subid" class="form-control" >
                     <option disabled="disabled" selected="selected" > Select Subject</option>
                     <?php 
                          $query="SELECT Subject_name from subject where Teacher_id='$id'";
                    ...
                    <a href="http://127.0.0.1:5000" > <button type="button" name="submit" class="btn btn-primary" >  save  </button></a>
                    </div>
                  </form>              
      </div>
    </section>
