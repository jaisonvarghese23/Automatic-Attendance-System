...
$sql = "SELECT * FROM HOD where HOD_id = '$id' ORDER BY fname";
...
while($row = mysqli_fetch_array($result)){
    ...
    $output .= '     <div class="col-md-8 col-lg-9">';
    $output .= '       <input name="fullname" value="'.$row["fname"].'" type="text" class="form-control" id="fullName" >';
    $output .= '     </div>';
    $output .= '   </div>';
    $output .= '               <div class="row mb-3">
   ...
   $output .= '          <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email"  value="'.$row["email1"].'"  type="email" class="form-control" id="Email" >
                      </div>
                    </div>
                    <div class="row mb-3">
