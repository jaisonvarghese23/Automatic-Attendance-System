      ...
      <div class="row">
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="pt-2">
                          ...
                          <button class="btn btn-danger btn-sm" onclick="getremove()" title="Remove my profile image"><i class="bi bi-trash"></i></a>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="Age" type="text" class="form-control" id="company" >
                      </div>
                    </div>
                    <div class="row mb-3">
