...
$query="SELECT * from HOD where email1 = '$name'";
...
while($row = mysqli_fetch_assoc($rt))
  ...
  if(isset($_POST['editsubmit'])){
   ...
   $q="SELECT images FROM HOD where  HOD_id = '$id' ";
  ...
  //    $filename = $_FILES["p"]["name"];
   ...
   // $i=mysqli_fetch_assoc($row['images']);
    $query="UPDATE HOD SET images='$pimage', fname='$names',age='$age',email1='$email',phone='$phone',instagram1='$instagram',facebook1='$link' where HOD_id = '$id' ";
  ...
  if(isset($_POST['passwordsubmit'])){
    ...
    $query="UPDATE HOD SET password1='$currentpass' WHERE HOD_id = '$id'";
    $result=mysqli_query($con,$query);
    if($result){
...
$query = " select * from HOD where  HOD_id = '$id' ";
$result = mysqli_query($con, $query);
