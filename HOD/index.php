  ...
  $name= $_SESSION['uname2'];
                       ...
                       while($row = mysqli_fetch_assoc($rt))
                         ...
                         case
                           ...
                           end as present1 FROM attendance where Department='$Department' GROUP BY present1";
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      $query = "SELECT count(1) From student where Department='$Department'";
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      $query = "SELECT count(1) From teachers where Department='$Department'";
                      $c=mysqli_query($con,$query);
                      $row = mysqli_fetch_array($c);
                      echo $row[0];
                      ?></h6>
...
?>
  ...
  var options = { animation: {
    ...
    segmentShowStroke : false
      },pieHole:0.3,legend:'none',slices:{0:{color:'#16924E'},1:{color:'#C21B25'}}};
  ...
  var options2 = {pieHole:0.3,legend:'none',slices:{0:{color:'#16924E'},1:{color:'#C21B25'}}};
