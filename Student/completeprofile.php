...
$ktu=$data['ktu_id'];
  ...
  if(isset($_POST['passwordsubmit'])){
    ...
    $query="UPDATE student SET password1='$currentpass' WHERE ktu_id = '$ktu'";
    $result=mysqli_query($con,$query);
    if($result){
      ...
      <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="/AMP/Staff_Adviser/Student/<?php echo $data['images'] ?>" alt="Profile" class="rounded-circle">
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Staff Adviser Name</div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $data['current_Semester']; ?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">KTU ID</div>
                    <div class="col-lg-9 col-md-8"><?php echo $data['ktu_id']; ?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Roll No </div>
                    <div class="col-lg-9 col-md-8"><?php echo $data['Roll_no']; ?></div>
                  </div>
                  

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Batch</div>
                    <div class="col-lg-9 col-md-8"><?php echo $row['Batch']; ?></div>
                  </div>
